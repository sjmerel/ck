...
// XXX added to CK to fix link errors when targeting SDK 14 and below on Android
static __inline int ck_abs(int __n) { return (__n < 0) ? -__n : __n; }
static __inline long ck_labs(long __n) { return (__n < 0L) ? -__n : __n; }
